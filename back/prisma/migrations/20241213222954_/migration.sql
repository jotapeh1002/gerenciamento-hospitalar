/*
  ...
  - Added the required column `statusprofessional` to the `duty_schedule` table without a default value. This is not possible if the table is not empty.
  - Added the required column `statusprofessional` to the `procedure` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `duty_schedule` DROP COLUMN `status`,
    ADD COLUMN `statusprofessional` VARCHAR(191) NOT NULL;
...
ALTER TABLE `professional` DROP COLUMN `status`,
    ADD COLUMN `statusprofessional` VARCHAR(191) NOT NULL DEFAULT 'ativo';
